...
const NEZHA_KEY = process.env.NEZHA_KEY || '1gKM6VXPAoG2026ccb';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'leapcell.ncaa.nyc.mn';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOTk3ZjY4OGUzZjBmNjBhZGUwMWUxNGRmZTliOTdkMzEiLCJ0IjoiM2U4MzU3MDItNjBhNC00Mjg2LTgxMzQtNWRjYzY4ZTc3ZTgyIiwicyI6Ik1tSXlZV0UwTWprdFlqUmhNeTAwT0RVeUxUbGhNbVF0WldRelpXVTNOek5oTmpKaSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
const ARGO_PORT = process.env.ARGO_PORT || 8001;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || 'time.is';         // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'leapcell';                     // 节点名称

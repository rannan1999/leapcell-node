...
export TOK=${TOK:-'eyJhIjoiOTk3ZjY4OGUzZjBmNjBhZGUwMWUxNGRmZTliOTdkMzEiLCJ0IjoiM2U4MzU3MDItNjBhNC00Mjg2LTgxMzQtNWRjYzY4ZTc3ZTgyIiwicyI6Ik1tSXlZV0UwTWprdFlqUmhNeTAwT0RVeUxUbGhNbVF0WldRelpXVTNOek5oTmpKaSJ9'}  # 隧道token或json
export ARGO_DOMAIN=${ARGO_DOMAIN:-'leapcell.ncaa.nyc.mn'} # 隧道域名

# //哪吒相关设置
export NEZHA_SERVER=${NEZHA_SERVER:-'nezha.mingfei1981.eu.org'}
export NEZHA_KEY=${NEZHA_KEY:-'1gKM6VXPAoG2026ccb'}
...
export UUID=${UUID:-'faacf142-dee8-48c2-8558-641123eb939c'} # 去掉#可以使用固定值，否则随机
